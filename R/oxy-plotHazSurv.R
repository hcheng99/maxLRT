...
#' @param param PARAM_DESCRIPTION, Default: c(1.2, 0.03)
#' @param fun_list PARAM_DESCRIPTION, Default: fun_list
#' @param end PARAM_DESCRIPTION
#' @param tit PARAM_DESCRIPTION, Default: c("Hazard Function", "Survival Function")
#' @param pos PARAM_DESCRIPTION, Default: c(1, 2)
#' @param f_n PARAM_DESCRIPTION, Default: 1
